...
import { Usuario, UsuariosService } from '../src/usuarios/domain';
import * as request from 'supertest';
import { Reflector } from '@nestjs/core';
import { ValidadorPipe } from '../src/shared';
import { JwtAuthGuard } from '../src/auth/domain';
...
describe('auth', () => {
  ...
  describe('login', () => {
    ...
    it('deve fazer o login de um usuario ja cadatrado', async () => {
      await usuariosService.cadastra(
